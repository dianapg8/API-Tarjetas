...
public interface TarjetaRepository extends JpaRepository<Tarjeta,Long> {
    ...
    @Query("SELECT a FROM Tarjeta a WHERE a.preferencia = ?1 AND ?2 BETWEEN a.edadMinima and a.edadMaxima " +
            "AND a.salarioMinimo <= ?3 and (a.salarioMaximo >= ?3 or a.salarioMaximo is NULL)")
